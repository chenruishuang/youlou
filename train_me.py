...
# =============================================================================
#imdb_test_map = VOCDataset(cfg.imdb_test, cfg.DATA_DIR, cfg.batch_size,
#                  yolo_utils.preprocess_test, processes=1, shuffle=False,
#                  dst_size=cfg.multi_scale_inp_size)
# =============================================================================
#imdb = VOCDataset(cfg.imdb_train, cfg.DATA_DIR, cfg.train_batch_size, yolo_utils.preprocess_train, 
#                  shuffle=False, dst_size=cfg.multi_scale_inp_size)
#
#loader = Data.DataLoader(imdb, batch_size=cfg.train_batch_size, shuffle=True, num_workers=5)
#----------------------------------------------------------------------------------------
...
# test _ new _ pic to test model
# =============================================================================
# =============================================================================
#         net.eval()
#         test_me.test_net(net, imdb_test,max_per_image = 10 , thresh = 0.5 , vis=False)
#         net.train()
# =============================================================================
...
# =============================================================================
        ...
        save_txt_f.writelines(['{}_{}.h5'.format(cfg.exp_name, imdb.epoch),'\n'])
        save_txt_f.close()
